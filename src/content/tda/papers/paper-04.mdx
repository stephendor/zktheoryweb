...
abstract: >
  Poverty traps — states from which exit is structurally impeded — represent a central concern of welfare research. Single-parameter persistent homology cannot distinguish trapping configurations from transient low-income spells. This paper introduces a multi-parameter persistent homology (MPH) framework that simultaneously filters employment trajectory space by income level and time, yielding a two-parameter persistence module. Applied to Understanding Society data, MPH identifies the topological signature of poverty trap configurations as the **absence** of H₁ at low income levels — a region of impoverished connectivity rather than isolated enclosure — inverting the initial hypothesis. The geographic concentration hypothesis (trap-topology concentrated in specific NUTS-2 regions) was not supported in exploratory analysis; full-scale GPU computation is underway to confirm the income-gradient finding and enable spatial disaggregation.
plain_summary: >
  Not all periods of low income are equal. Some people experience temporary financial hardship and recover; others are structurally trapped in persistent poverty. Standard statistics struggle to tell these apart. This paper uses a two-dimensional version of topological data analysis — scanning both income level and time simultaneously — to detect the mathematical signature of being trapped. The central finding is counterintuitive: poverty trap topology is characterised by the *absence* of complex loop structures at low income levels, not by isolated pockets. Low-income trajectories are topologically simpler, with fewer routes in or out, while higher-income trajectories are richly connected. The geographic concentration hypothesis was not supported in exploratory analysis. Full-scale computation is continuing.
---
