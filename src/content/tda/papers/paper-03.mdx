...
abstract: >
  Standard persistent homology analyses a single filtration. Zigzag persistence extends this to sequences of spaces and maps, enabling the tracking of topological features as they appear and disappear through time. This paper applies zigzag persistence to the BHPS and Understanding Society panels to measure how the topological structure of employment trajectory space shifts across macroeconomic cycles. H₁ loop structures are found to be non-significant across both survey eras; topological complexity instead tracks GDP growth (not unemployment rates), suggesting trajectory topology captures income-band cycling rather than employment-status cycling. The dominant post-2008 topological discontinuity is identified as a BHPS→USoc survey-design artefact rather than a genuine GFC signature, and a genuine secular flexibilisation trend is isolated within the 1991–2008 BHPS era.
plain_summary: >
  The shape of employment histories changes over time — but not always in the way you might expect. Topological loop structures (H₁ features) turn out to be non-significant across the dataset; what actually tracks the economy is a broader measure of topological complexity, and it correlates with GDP growth rather than unemployment rates. The 2008 discontinuity — initially the most dramatic signal — turns out to be a survey-design artefact caused by the change from BHPS to Understanding Society's different state-coding scheme, not a genuine signature of the Global Financial Crisis. The genuine finding is a secular flexibilisation trend within the 1991–2008 period: trajectory space becomes progressively more fragmented as fixed-term contracts proliferate, with a temporary spike at the 1993 recession.
---
