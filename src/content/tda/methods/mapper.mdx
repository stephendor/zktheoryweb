...
The choice of lens function $f$ determines what structure Mapper highlights. In this programme, $f$ is the 2nd-nearest-neighbour distance lens (`projection="knn_distance_2"`), which maps each point to its distance to its second closest neighbour and thereby highlights low-density regions and topological bridges in the trajectory space.
