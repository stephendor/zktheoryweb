...
Memory duties are assigned to the _Manager Agent_ - who maintains the system. Details on individual Memory Log files reside in .apm/guides/Memory_Log_Guide.md.
