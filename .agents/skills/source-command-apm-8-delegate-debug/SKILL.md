---
name: "source-command-apm-8-delegate-debug"
description: "Provides the template for delegating a complex debugging task to an Ad-Hoc agent"
---

# source-command-apm-8-delegate-debug

Use this skill when the user asks to run the migrated source command `apm-8-delegate-debug`.
