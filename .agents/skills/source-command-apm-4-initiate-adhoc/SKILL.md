---
name: "source-command-apm-4-initiate-adhoc"
description: "Initializes a temporary Ad-Hoc Agent for an isolated task (e.g., debugging)"
---

# source-command-apm-4-initiate-adhoc

Use this skill when the user asks to run the migrated source command `apm-4-initiate-adhoc`.

## Command Template

# APM 0.5.4 – Ad-Hoc Agent Initiation Prompt
...
3. **Deliver final results** in **markdown code block** format for copy-paste integration upon User confirmation
   - **CRITICAL:** The User _must_ be able to copy your _entire_ structured findings from a _single_ markdown code block to return them to the calling Implementation Agent.
