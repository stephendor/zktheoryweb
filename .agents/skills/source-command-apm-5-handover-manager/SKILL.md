---
name: "source-command-apm-5-handover-manager"
description: "Initiates and guides a Manager Agent through the handover procedure to a new agent instance."
---

# source-command-apm-5-handover-manager

Use this skill when the user asks to run the migrated source command `apm-5-handover-manager`.
