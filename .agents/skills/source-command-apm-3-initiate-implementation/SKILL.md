---
name: "source-command-apm-3-initiate-implementation"
description: "Initializes an Implementation Agent for focused, domain-specific task execution"
---

# source-command-apm-3-initiate-implementation

Use this skill when the user asks to run the migrated source command `apm-3-initiate-implementation`.
...
**When User requests iterations:** 2. **Fulfill modification requests** completely and thoroughly, ask clarification questions if ambiguity exists 3. **Re-ask for confirmation**: "I've made the requested modifications to Step [X]. Please confirm to proceed to Step [X+1], or let me know if additional changes are needed."
...
2. **Read .Codex/commands/apm-8-delegate-debug.md** - Follow the guide exactly
...
4. **Update Memory Log**: Complete designated log file per .apm/guides/Memory_Log_Guide.md
5. **Report Results**: Inform the User of task completion, issues encountered, or blockers for Manager Agent review.
...
- .Codex/commands/apm-8-delegate-debug.md for debugging issues
- .Codex/commands/apm-7-delegate-research.md for information gathering
