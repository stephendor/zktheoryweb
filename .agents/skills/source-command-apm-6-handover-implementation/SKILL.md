---
name: "source-command-apm-6-handover-implementation"
description: "Initiates and guides an Implementation Agent through the handover procedure to a new agent instance"
---

# source-command-apm-6-handover-implementation

Use this skill when the user asks to run the migrated source command `apm-6-handover-implementation`.

## Command Template

# APM 0.5.4 - Implementation Agent Handover Prompt
