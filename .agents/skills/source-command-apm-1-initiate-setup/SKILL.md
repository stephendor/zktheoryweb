---
name: "source-command-apm-1-initiate-setup"
description: "Initializes a new APM project session and starts the Setup Phase with three steps."
---

# source-command-apm-1-initiate-setup

Use this skill when the user asks to run the migrated source command `apm-1-initiate-setup`.
