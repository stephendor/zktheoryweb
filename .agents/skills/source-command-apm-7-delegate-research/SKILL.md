---
name: "source-command-apm-7-delegate-research"
description: "Provides the template for delegating a research task to an Ad-Hoc agent"
---

# source-command-apm-7-delegate-research

Use this skill when the user asks to run the migrated source command `apm-7-delegate-research`.
...
2. Open new Ad-Hoc agent chat session & initialize it with .Codex/commands/apm-4-initiate-adhoc.md
