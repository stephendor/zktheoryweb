...
2. **Read .claude/commands/apm-8-delegate-debug.md** - Follow the guide exactly
...
- .claude/commands/apm-8-delegate-debug.md for debugging issues
- .claude/commands/apm-7-delegate-research.md for information gathering
